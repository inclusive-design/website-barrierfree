...
As well, inside the preferences folder on your computer(/System Folder/Preferences) you should find a file with a name of the form "LR2003-Nov-01.log"  Please attach to your email the file dated for the day you encountered the problem.
...
The BarrierFree folder contains an application called
	BarrierFreeEditor
Simply double-click the file to run the Editor.
...
The BarrierFree folder contains an application called
	BarrierFreePlayer
Simply double-click the file to run the Player.
